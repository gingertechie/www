...
So, in order for the map to work on a single A4 page, I had to define some criteria to decide who made it on the map, and who got a lump of coal in their sack. Or a term sheet from a local VC. 😎

I sense you have questions.

> Who gave me the right to set the criteria?

Nobody.

> Can the criteria be changed?

Sure.

> Will there be other maps with different criteria?

I refer you to the “infinite time” answer I gave previously.

### The Rules

When I first wrote the criteria, I wrote them in an overcomplicated negatively-phrased way. What else would you expect from a former software engineer? Here’s an attempt to simplify The Rules:

* Your Company must be founded in Ireland
* Your Company must target Financial Services exclusively
* Your Company must implement a technology solution
* Your Product must be generally available to the market
...
Ok, enough of that silliness. What’s new on Ireland’s Fintech Map version 0.7?

* [Accounts IQ](http://www.accountsiq.com)
* [Assured Web Services](http://www.assured.ie)
* [CalQRisk](http://www.calqrisk.com)
* [Cashdash](http://www.cashdash.ie)
* [Ostia](http://www.ostiasolutions.com)
* [Piggypot](http://www.piggypot.com)
