---
title: "You Definitely Can’t Automate Business Analysis. Or can you?"
description: "What happens when you realise most businesses are just variations on a theme"
publicationDate: 2026-01-06T21:39:00Z
image: ""
---
...
| Exchange             | Resource Out	                 | Resource In                | External Agent|
|----------------------|---------------------------------|----------------------------|-------------------|
| Advisory Service     | Advice/guidance (labour)        | Commission (from provider) |	Pension Provider  |
| Customer Acquisition | Marketing spend (cash)	         | Customer relationship      | Customer          |
| Policy Placement     | Application processing (labour) | Initial commission         | Pension Provider  |
...
|Layer	                  | Purpose	                           | Key Frameworks                 |
|-------------------------|-------------------------------------|--------------------------------|
|Enterprise Architecture&nbsp;|  Structure the whole enterprise.     | TOGAF, Zachman, ArchiMate      |
|Business Capability     | What the business can do (abstract) | Business Capability Maps, BIAN |
|Process Classification  | Categorise and compare processes.   | APQC, eTOM, SCOR, VRM |
|Process Modeling        | Document specific process flows.    | BPMN, EPC |
|Decision Modeling       | Document business rules/logic.      | DMN, SBVR |
|Requirements Syntax     | Write unambiguous requirements.     | EARS, Planguage |
|Ontology/Semantics	     | Formal knowledge representation.    | OWL, REA, FIBO |

This helped my tiny mind to understand the landscape. I’d been confused about whether BPMN was an alternative to APQC (it isn’t — they operate at different layers). I’d been unsure where REA fit (ontology layer — useful for transactional situations, not scaffolding). The stack made sense of the territory.

Within the process classification layer itself, APQC isn’t the only option:

|Framework | Scope                         | Best For
|----------|-------------------------------|------------------------------|
|APQC PCF  | Universal (~1,500 processes)  | General business, my default |
|eTOM      | Telecom only	               | Telcos, network operators    |
|SCOR      | Supply chain                  | Manufacturing, logistics     |
|BIAN      | Banking only                  | Banks, financial services    |
|Porter's Value Chain| Strategic (9 activities)| Executive communication  |
